<p align="center">
  <img src="banner.png" alt="ZENTHOS banner" width="100%">
</p>

<h1 align="center">Hi, I'm Zenthos 👋</h1>

<p align="center">
  <b>AIGC 视觉工程师 · AI Agent 开发者 · 室内设计师</b><br/>
...
> 四个方向：AI 健身应用 · 群聊知识压缩 · 生图 Agent 自迭代 · OpenClaw 方法论与增强工具

| Project | What it does | Stack |
|---------|-------------|-------|
| [**zenclaw**](https://github.com/zenthos-z/zenclaw) | 🦞 OpenClaw 学习方法论与功能增强工具集：知识地图法 / 论文调研法 / 视觉 Prompt 法 + 文件列车 / 知识地图 Viewer | Markdown · HTML · JSON |
...
| [**img-iter-agent**](https://github.com/zenthos-z/img-iter-agent) | 🎨 benchmark 驱动的 AI 生图 Agent 自迭代系统：Generator × Critic × ExperienceDistiller 三 Agent 双闭环——对抗博弈 + 经验蒸馏自动收敛最优 prompt 策略 | Python · LangGraph · LLM Eval |
...
| [**quick-img**](https://github.com/zenthos-z/my-skills/tree/main/quick-img) | 快速生图：Direct/Template 双模式、网络搜索自动补参考图、14 种宽高比、透明背景 | Python + DMX API |
